...
#get paths of subdirectories that start with letter p. ex) p01_s1
def get_paths():
    path_list = []
    name_list = []
...
#get csv files 
def get_affect_labels(paths, suffix = ".csv"):
    for path in paths:
...
if __name__ == "__main__":
    ...
    affect_labels = get_affect_labels(paths)
    print(affect_labels)
    data_array = to_df(affect_labels,paths)
    print(data_array)
